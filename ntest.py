...
def main(page: ft.Page):
    ...
    # 2) Tenta importar Android *depois* de renderizar a UI
    try:
    ...
    # 3) Obtém Activity e NFC Adapter
    ...
    # 4) Configura o foreground dispatch
    ...
    # 5) Callback de novas intents NFC
